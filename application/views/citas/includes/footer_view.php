...
<script src="<?php echo base_url(); ?>assets/js/fullcalendar.js"></script> <!-- Full Google Calendar - Calendar -->
...
$('#atiende').change(function() {
  $("#atiende_text").val($('#atiende').find('option:selected').text());
});
