...
<div class="content">
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-inner">
          ...
          <?php $data["current"] = "configuracion"; $this->load->view("regiones/includes/menu",$data); ?>
...
<?php echo form_open('regiones/save', $create_form); ?>

                      <div class="control-group">
                        <label class="control-label" for="nombre">Región</label>
                        <div class="controls">
