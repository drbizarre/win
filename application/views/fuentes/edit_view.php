...
<?php echo form_open('fuentes/update', $create_form); ?>
<input type="hidden" id="id" name="id" value="<?php echo $fuente->id; ?>">

                      <div class="control-group">
                        <label class="control-label" for="nombre">Nombre</label>
                        <div class="controls">
							            <input type="text" id="nombre" name="nombre" value="<?php echo $fuente->nombre; ?>"  class="span5">
                        </div>
                      </div>
                      <hr>
