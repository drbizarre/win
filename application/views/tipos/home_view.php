...
<div id="myModal" class="modal hide">
    ...
    <div class="modal-body">
        <p>Eliminando tipo de archivo del sistema.</p>
        <p>Estas seguro?</p>
    </div>
    ...
    <!-- Sidebar ends -->
  	...
  	<div class="mainbar">
        ...
        <!-- Page heading -->
          ...
          <!-- page meta -->
          <span class="page-meta">Archivos que cada empleado puede registrar</span>
        </h2>
                ...
                <div class="widget-head">
                  <div class="pull-left">Tipo</div>
                       <div class="pull-right">
                        <p><a href="<?php echo site_url("tipos/nuevo"); ?>" class="btn btn-primary">Nuevo</a></p>
                      </div>
                  <div class="clearfix"></div>
                </div>
                  ...
                  <div class="widget-content">
                    ...
                    if (isset($tipos) && !empty($tipos)) {
                      foreach ($tipos as $tipo) {
                        ...
                        <td>
                              <a class=\"btn btn-mini btn-warning\" href=\"".site_url("tipos/edit/".$tipo->id)."\"><i class=\"icon-pencil\"></i> </a>
                              <a class=\"btn btn-mini btn-danger\" data-id=\"".$tipo->id."\" href=\"".site_url("tipos/delete/".$tipo->id)."\"><i class=\"icon-remove\"></i> </a>                        
                        </td>
                        </tr>";
                      }
                    }else{
