<ul class="navi">
            ...
            <li class="nlightblue <?php echo ($current=="empresas")?"current":""; ?>"><a href="<?php echo site_url("empresas"); ?>"><i class="icon-file"></i> Empresas</a></li>
<li class="nlightblue <?php echo ($current=="empleados")?"current":""; ?>"><a href="<?php echo site_url("empleados"); ?>"><i class="icon-group"></i> Empleados</a></li>
<li class="nlightblue <?php echo ($current=="archivos")?"current":""; ?>"><a href="<?php echo site_url("archivos"); ?>"><i class="icon-money"></i> Archivos</a></li>
            <li class="nlightblue <?php echo ($current=="nominas")?"current":""; ?>"><a href="<?php echo site_url("nominas"); ?>"><i class="icon-user"></i> Nominas</a></li>                        
            ...
            <li class="has_submenu nlightblue <?php echo ($current=="configuracion")?"current open":""; ?>">
              <a href="#">
                ...
                <ul>
                   ...
                   <li><a href="<?php echo site_url("tipos"); ?>">Tipos de archivo</a></li>
