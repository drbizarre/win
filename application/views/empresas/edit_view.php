...
<?php echo form_open('empresas/update', $create_form); ?>
...
<div class="row-fluid">
                        ...
                        <div class="span12">
                          <div class="control-group">
                            ...
                            <div class="controls">
                              <input type="text" id="nombre" name="nombre" value="<?php echo $empresa->nombre; ?>"  >
                            </div>
                          </div>
                        </div>
                        <div class="span12">
                      ...
                      <label class="control-label" for="descripcion">Descripcion</label>
                        <div class="controls">
                          <input type="text" id="descripcion" name="descripcion" value="<?php echo $empresa->descripcion; ?>" class="span8">
                        </div>
                      </div>    
