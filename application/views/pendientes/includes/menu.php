...
<li class="nlightblue <?php echo ($current=="prospectos")?"current":""; ?>">
            ...
            <li class="nlightblue <?php echo ($current=="pendientes")?"current":""; ?>"><a href="<?php echo site_url("pendientes"); ?>"><i class="icon-time"></i> Pendientes</a></li>            
