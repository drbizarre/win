...
<div class="navbar navbar-fixed-top navbar-inverse">
  <div class="navbar-inner">
    <div class="container">
      ...
      <a href="<?php echo site_url("clientes"); ?>" class="brand">Spacia <span class="bold"></span></a>
        ...
        <ul class="nav pull-right">
          <li class="dropdown pull-right">            
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
              <?php echo ($this->session->userdata('user_level') == $this->config->item('admin_level')) ? "Administrador" : ($this->session->userdata('user_level')==1)?"Cliente: ".$this->session->userdata('first_name'):"Cliente"; ?> <b class="caret"></b>              
            </a>
